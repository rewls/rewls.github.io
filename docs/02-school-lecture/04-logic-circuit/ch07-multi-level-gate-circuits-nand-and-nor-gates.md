...
![circuit1-1](/assets/logic-circuit/img/7-1-circuit1-1.png)
...
<center markdown="block">
![circuit1-2](/assets/logic-circuit/img/7-1-circuit1-2.png)
...
<center markdown="block">
![circuit2-1](/assets/logic-circuit/img/7-1-circuit2-1.png)
...
<center markdown="block">
![circuit2-2](/assets/logic-circuit/img/7-1-circuit2-2.png)
...
<center markdown="block">
![circuit2-3](/assets/logic-circuit/img/7-1-circuit2-3.png)
...
<center markdown="block">
![circuit2-5](/assets/logic-circuit/img/7-1-circuit2-5.png)
...
<center markdown="block">
![nand](/assets/logic-circuit/img/7-2-nand.png)

NAND

![nor](/assets/logic-circuit/img/7-2-nor.png)
...
<center markdown="block">
![and](/assets/logic-circuit/img/7-2-and.png)
...
- AND and NOT are a functionally complete set of gates because OR can also be realized using AND and NOT
	...
	<center markdown="block">
	![or-andnot](/assets/logic-circuit/img/7-2-or-andnot.png)
...
- OR and NOT are a functionally complete set of gates because OR can also be realized using OR and NOT
	...
	<center markdown="block">
	![and-ornot](/assets/logic-circuit/img/7-2-and-ornot.png)
...
- The NAND gate is functionally complete.
	...
	<center markdown="block">
	![not-nand](/assets/logic-circuit/img/7-2-not-nand.png)

	NOT realized using NAND

	![and-nand](/assets/logic-circuit/img/7-2-and-nand.png)

	AND realized using NAND

	![or-nand](/assets/logic-circuit/img/7-2-or-nand.png)
...
- The NOR gate is functionally complete.
	...
	<center markdown="block">
	![not-nor](/assets/logic-circuit/img/7-2-not-nor.png)

	NOT realized using NOR

	![and-nor](/assets/logic-circuit/img/7-2-and-nor.png)

	AND realized using NOR

	![or-nor](/assets/logic-circuit/img/7-2-or-nor.png)
...
<center markdown="block">
![sop-nand-nand](/assets/logic-circuit/img/7-3-sop-nand-nand.png)

SOP $\rightarrow$ NAND-NAND

![pos-nor-nor](/assets/logic-circuit/img/7-3-pos-nor-nor.png)
...
<center markdown="block">
![nand-ornot](/assets/logic-circuit/img/7-3-nand-ornot.png)

$(XY)^{\prime}=X^{\prime}+Y^{\prime}$

![nor-andnot](/assets/logic-circuit/img/7-3-nor-andnot.png)

$(X+Y)^{\prime}=X^{\prime}Y^{\prime}$

![notnand-or](/assets/logic-circuit/img/7-3-notnand-or.png)

$(X^{\prime}Y^{\prime})^{\prime}=X+Y$

![notnor-and](/assets/logic-circuit/img/7-3-notnor-and.png)
...
<center markdown="block">
![and-or](/assets/logic-circuit/img/7-3-and-or.png)

AND-OR

![and-not-not-or](/assets/logic-circuit/img/7-3-and-not-not-or.png)
![nand-nand](/assets/logic-circuit/img/7-3-nand-nand.png)

NAND-NAND

![not-or-nand](/assets/logic-circuit/img/7-3-not-or-nand.png)
![or-nand](/assets/logic-circuit/img/7-3-or-nand.png)

OR-NAND

![or-not-not-nand](/assets/logic-circuit/img/7-3-or-not-not-nand.png)
![nor-or](/assets/logic-circuit/img/7-3-nor-or.png)
...
<center markdown="block">
![multi-level-and-or](/assets/logic-circuit/img/7-4-multi-level-and-or.png)

Multi-level AND, OR

![multi-level-nand](/assets/logic-circuit/img/7-4-multi-level-nand.png)
